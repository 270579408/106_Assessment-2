...
namespace _106_Assessment_2.View.Pages
{
    public partial class ParkInfo : Page
    {
        ...
        {
            new facilityItem { Name = "Free Parking", ImagePath = "/Resources/car-parking-signal-golden.png" },
            new facilityItem { Name = "Cafe & Picinic Areas", ImagePath = "/Resources/cafe-golden.png" },
            new facilityItem { Name = "Gift Shop", ImagePath = "/Resources/gift-shop-golden.png" },
            new facilityItem { Name = "Restrooms", ImagePath = "/Resources/restroom-golden.png" },
            new facilityItem { Name = "Wheelchair Accessibility", ImagePath = "/Resources/wheelchair-golden.png" },
            new facilityItem { Name = "Guided Tours Available", ImagePath = "/Resources/guide-golden.png" },
            new facilityItem { Name = "Free Wifi", ImagePath = "/Resources/free-wifi-golden.png" },
        };
